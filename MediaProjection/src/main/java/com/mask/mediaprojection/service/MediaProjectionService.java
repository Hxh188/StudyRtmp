...
import com.huang.android.video_rtmp.VideoCodec;
...
//    @android.support.annotation.RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    private void createMediaRecorder(final long rtmpPtr) {
...
//        }
        ...
        new Thread(){
            ...
            public void run() {
                ...
                videoCodec.init(rtmpPtr, width, height);
                Surface surface = videoCodec.getSurface();
                Log.e(TAG, surface + "   ===== surface =====");
                if (virtualDisplayMediaRecorder == null) {
                    virtualDisplayMediaRecorder = mediaProjection.createVirtualDisplay("MediaRecorder",
                            width, height, densityDpi, DisplayManager.VIRTUAL_DISPLAY_FLAG_PUBLIC,
                            surface, null, null);
                } else {
     ...
     * @param callback callback
     */
    public void startRecording(long rtmpPtr, MediaRecorderCallback callback) {
